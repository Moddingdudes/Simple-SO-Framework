...
namespace CyberneticStudios.SOFramework
{
    ...
    public abstract class GameEvent<T1, T2> : ScriptableObject
    {
        ...
        public System.Action<T1, T2> OnGameEventRaised;
        [SerializeField] DebugInformation debugInformation;

        public void RaiseEvent(T1 valueOne, T2 valueTwo)
        {
            OnGameEventRaised?.Invoke(valueOne, valueTwo);
            ...
            if (debugInformation.debugEnabled)
            {
                ...
                if (debugInformation.includeData)
                    debugMessage += valueOne + " " + valueTwo;
